...
def send_admin_menu_category(bot_token: str, chat_id: int, tenant_id: str, orders_sh, sess: Dict[str, Any], category: str) -> bool:
    menu_idx = load_menu_admin_index(orders_sh, force=False)
    cats = group_menu_admin_by_category(menu_idx)
...
def send_admin_menu_product_detail(bot_token: str, chat_id: int, tenant_id: str, orders_sh, sess: Dict[str, Any], sku: str) -> bool:
...
def send_admin_menu_price_editor(bot_token: str, chat_id: int, tenant_id: str, orders_sh, sess: Dict[str, Any], sku: str) -> bool:
    item = get_menu_product_or_404(orders_sh, sku)
